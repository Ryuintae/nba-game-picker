                ...
                <div className="flex items-center gap-6 lg:gap-10">
                    <Link href="/" className="flex items-center gap-3">
                        <div className="flex h-11 w-11 items-center justify-center">
                            <div className="relative h-11 w-11 overflow-hidden rounded-full bg-[radial-gradient(circle_at_30%_30%,#fdba74_0%,#f97316_45%,#ea580c_75%,#c2410c_100%)] shadow-[0_6px_16px_rgba(234,88,12,0.28)] ring-1 ring-black/10 dark:ring-white/10">
                                ...
                                <div className="absolute inset-y-[5px] left-[-9px] w-7 rounded-full border-2 border-[#5b341a]/55" />
                                <div className="absolute inset-y-[5px] right-[-9px] w-7 rounded-full border-2 border-[#5b341a]/55" />
                                <div className="absolute left-[7px] top-[7px] h-2.5 w-2.5 rounded-full bg-white/25 blur-[1px]" />
                            </div>
                        </div>
