import MatchupDivergingBarChart from "@/features/nba/components/home/MatchupDivergingBarChart";
    ...
    return (
        <div className="h-full border border-black/8 bg-[#fbfcfd] p-4 dark:border-white/10 dark:bg-[#17191d] sm:p-5">
            <div className="flex h-full flex-col">
                ...
                <div className="mt-4 flex items-center justify-between gap-3 border-y border-black/8 py-3 dark:border-white/10">
