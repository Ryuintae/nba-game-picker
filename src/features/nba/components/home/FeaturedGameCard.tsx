        ...
        >
            ...
            <div className="relative text-neutral-950 dark:text-white">
                <div className="flex items-center justify-between gap-3">
                    <p className="text-[12px] text-neutral-700 dark:text-white/72">
                        {game.time}
                    </p>
                ...
                <div className="mt-6">
                    <div className="flex items-center justify-between gap-3">
                        <div>
                            <p className="text-[13px] text-neutral-700 dark:text-white/70">
                                Away
                            </p>
                        ...
                        <div className="text-[14px] font-medium text-neutral-400 dark:text-white/35">
                            VS
                        </div>
                    ...
                    <div className="mt-6 flex flex-wrap gap-2">
                        {["Closeness", "Scoring", "Momentum"].map((label) => (
                            <span
                                key={label}
                                className="rounded-full border border-black/10 bg-white/55 px-3 py-1 text-[11px] text-neutral-800 backdrop-blur-sm dark:border-white/14 dark:bg-black/22 dark:text-white/82"
                            >
                                {label}
                            </span>
                        ))}
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-3">
                        <div className="rounded border border-black/10 bg-white/58 p-4 backdrop-blur-sm dark:border-white/14 dark:bg-black/20">
                            <p className="text-[11px] text-neutral-600 dark:text-white/68">
                                최근 5경기
                            </p>
