                ...
                >
                    <div className="flex items-center justify-between gap-5">
                        <div className="flex items-center gap-4">
                            <TeamLogo src={game.awayTeam.logoUrl} alt={game.awayTeam.displayName} />
                            <div>
                            ...
                            <TeamLogo src={game.homeTeam.logoUrl} alt={game.homeTeam.displayName} />
                        </div>
                        ...
                        <div className="text-right">
                            ...
                            <p className="mt-1 text-3xl font-black">{game.matchupScore}</p>
                        </div>
                    </div>
                </Link>
            ))}
